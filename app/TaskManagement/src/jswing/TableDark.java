...
public class TableDark extends JTable {
    ...
    public void deleteRow() {
        ...
        if (this.getSelectedRow() == 1) {
            mod.removeRow(this.getSelectedRow());
        } else {
            if (this.getRowCount() == 0) {
                JOptionPane.showMessageDialog(MainJFrame.getFrames()[0], "Table is empty");
            } else {
                JOptionPane.showMessageDialog(MainJFrame.getFrames()[0], "Select a row to delete");
            }
        }
    }
