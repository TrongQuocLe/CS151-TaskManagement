...
public class LoginAndRegister extends JPanel {
    ...
    public void setAnimate(int animate) {
        layout.setComponentConstraints(register, "pos (25%)-15px-" + animate + " 0.45al n n");
        layout.setComponentConstraints(login, "pos (50%)-15px+" + animate + " 0.45al n n");
        if (animate == 30) {
            if (isLogin) {
    ...
    private void init() {
        ...
        add(register, "pos (25%)-15px 0.45al n n");
        add(login, "pos (50%)-15px 0.45al n n");
